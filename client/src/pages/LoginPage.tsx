  ...
  return (
    <div className="min-h-screen bg-neutral-100 text-neutral-900">
      <section className="bg-gradient-to-br from-brand-900 via-brand-800 to-brand-600 text-white">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-brand-100 text-sm">Smart Scheduling + Burnout Prevention for Hospitality</p>
          </div>
          <nav className="hidden md:flex gap-6 text-brand-100 text-sm font-medium">
            <span>Home</span>
            <span>About</span>
            <span>Features</span>
            <span>Tech Stack</span>
          </nav>
          <Button variant="secondary" size="sm" className="bg-white/10 border-white/30 text-white hover:bg-white/20">Github Repo</Button>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 pb-12 pt-6 grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="text-brand-100 text-lg mt-4 max-w-xl">Optimize schedules, reduce burnout, and control labor costs with one collaborative platform.</p>
            <div className="mt-7 grid sm:grid-cols-3 gap-3 max-w-xl">
              {HERO_STATS.map(stat => (
                <div key={stat.label} className="rounded-lg bg-white/10 border border-white/20 px-4 py-3">
                  <p className="text-xs text-brand-200 uppercase tracking-wide">{stat.label}</p>
          ...
          <div className="bg-neutral-900/80 border border-neutral-700 rounded-2xl p-5 shadow-2xl backdrop-blur-sm">
            <p className="text-sm text-brand-100 mb-3">Live Operations Snapshot</p>
            <div className="grid grid-cols-3 gap-3">
              <div className="rounded-md bg-neutral-800 p-3">
                <p className="text-xs text-neutral-400">Team on Duty</p>
                <p className="text-2xl font-bold">27</p>
              </div>
              <div className="rounded-md bg-neutral-800 p-3">
                <p className="text-xs text-neutral-400">Labor Cost</p>
                <p className="text-2xl font-bold">$920</p>
              </div>
              <div className="rounded-md bg-neutral-800 p-3">
                <p className="text-xs text-neutral-400">Swap Requests</p>
                <p className="text-2xl font-bold">3</p>
              </div>
            </div>
            <div className="mt-4 rounded-md bg-neutral-800 h-32 flex items-end justify-around px-4 pb-4">
              {[50, 82, 60, 95, 72, 88].map((height, index) => (
                <div key={index} className="w-7 bg-gradient-to-t from-brand-500 to-info rounded-t" style={{ height: `${height}%` }} />
              ))}
            </div>
          </div>
        </div>
      ...
      <section className="bg-white border-y border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 py-6 grid md:grid-cols-3 gap-5">
          {FEATURE_STRIP.map(feature => (
            <Card key={feature.title} className="bg-neutral-50">
              <h2 className="font-bold text-brand-900">{feature.title}</h2>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10 grid lg:grid-cols-2 gap-8 items-start">
        <div>
          <h2 className="text-3xl font-bold text-brand-900">Sign in to ShiftSync</h2>
          <p className="text-neutral-600 mt-2">Use your account to manage schedules, track burnout indicators, and keep staffing balanced.</p>
          ...
          <div className="mt-7 rounded-xl overflow-hidden border border-neutral-200 shadow-sm">
            <img
        ...
        <Card className="shadow-xl p-8">
          ...
          <div className="mt-6 p-4 bg-neutral-50 rounded-lg text-xs text-neutral-600">
            <p className="font-semibold text-neutral-800 mb-2">Demo Accounts (password: password123)</p>
      ...
      <section className="bg-white border-y border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <h2 className="text-3xl font-bold text-brand-900 text-center">Key Features</h2>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10 grid lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2 p-6">
          <h2 className="text-3xl font-bold text-brand-900">System Architecture</h2>
          <div className="mt-5 grid sm:grid-cols-3 gap-3 text-sm">
            <div className="border border-neutral-200 bg-neutral-50 rounded-lg p-3">
              ...
              <p className="text-neutral-600">React / Vite</p>
            </div>
            <div className="border border-neutral-200 bg-neutral-50 rounded-lg p-3">
              <p className="font-semibold text-brand-900">Backend</p>
              <p className="text-neutral-600">Express API</p>
            </div>
            <div className="border border-neutral-200 bg-neutral-50 rounded-lg p-3">
              <p className="font-semibold text-brand-900">Data</p>
              <p className="text-neutral-600">PostgreSQL</p>
            </div>
          </div>
        </Card>
        <Card className="p-6">
          <h3 className="text-2xl font-bold text-brand-900">Tech Stack</h3>
