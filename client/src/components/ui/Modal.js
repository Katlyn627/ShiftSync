...
export function Modal({ open, onClose, title, children, actions, className }) {
    return (_jsx(Dialog, { open: open, onOpenChange: (o) => { if (!o)
            onClose(); }, children: _jsxs(DialogContent, { className: className, children: [_jsx(DialogHeader, { children: _jsx(DialogTitle, { children: title }) }), _jsx("div", { className: "text-sm text-muted-foreground", children: children }), actions && _jsx(DialogFooter, { children: actions })] }) }));
}
